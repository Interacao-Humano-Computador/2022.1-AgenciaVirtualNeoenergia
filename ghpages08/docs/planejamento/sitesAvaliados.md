...
<p>O responsável pela avaliação foi o [Natan Santana](https://github.com/Neitan2001) e para a análise do sistema, foi realizada uma avaliação heurística, a fim de identificar e documentar problemas de usabilidade e design. Os problemas identificados afetaram as seguintes heurísticas:</p>
<ul>
...
<p>Os principais problemas referem-se a grande quantidade de informações dispostas de forma a dificultar a identificação das informações, menu com sobreposições que podem levar usuários a cometer erro e dificuldade de identificar onde o usuário se encontra no sistema. 
</p>
</div>
...
<p>A responsável pela avaliação foi a Luíza Esteves e os problemas identificados afetaram as seguintes heurísticas:</p>
...
<p> O responsável pela avaliação foi o Rafael Xavier e os problemas identificados afetaram as seguintes heurísticas:</p>
<ul>
  <li>Consistência e padrões</li>
  <li>Estética e design minimalista</li>
</ul>
...
<div style="text-align: justify">
  ...
  <p>O responsável pela avaliação foi o Daniel Coimbra e os problemas identificados afetaram as seguintes heurísticas:</p>
  <ul>
...
<p>O responsável pela avaliação foi o Matheus Perillo e os problemas identificados afetaram as seguintes heurísticas:</p>
  <ul>
    <li>Estética e design minimalista </li>
